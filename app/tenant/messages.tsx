...
export default function TenantMessagesPage() {
  ...
  const { booking_id, owner_id, property_name } = useLocalSearchParams<{
    booking_id: string; owner_id: string; property_name: string;
  }>();
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.headerTitle} numberOfLines={1}>{property_name || "Property Chat"}</Text>
          <Text style={styles.headerSub}>Chat with owner</Text>
        </View>
      </View>
              ...
              return (
                <View style={[styles.bubbleRow, isOwn && styles.bubbleRowOwn]}>
                  ...
                  <View style={[styles.bubble, isOwn ? styles.bubbleOwn : styles.bubbleTheirs]}>
                    {!isOwn && <Text style={styles.senderName}>{item.sender_name || "Owner"}</Text>}
...
const styles = StyleSheet.create({
  ...
  avatarCircle: { width: 28, height: 28, borderRadius: 14, backgroundColor: "#E0E7FF", alignItems: "center", justifyContent: "center" },
  ...
  senderName:   { fontSize: 10, fontWeight: "700", color: "#4F46E5", marginBottom: 2 },
