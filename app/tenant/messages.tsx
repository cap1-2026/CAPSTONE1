...
export default function TenantMessagesPage() {
  ...
  const { booking_id, owner_id, owner_name, property_name } = useLocalSearchParams<{
    booking_id:    string;
    owner_id:      string;
    owner_name:    string;
  ...
  async function sendMessage(forceMsg?: string) {
    ...
    if (!uid) {
      const freshUser = await UserStorage.getUser("tenant");
      if (freshUser) {
  ...
  function renderItem({ item }: { item: ListItem }) {
    ...
    const displayName = owner_name || msg.sender_name || "Owner";
  ...
  return (
    <SafeAreaView style={S.container} edges={["top"]}>
      ...
      <View style={S.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={S.headerName} numberOfLines={1}>{owner_name || "Property Owner"}</Text>
            ...
            ListEmptyComponent={
              <View style={S.empty}>
                ...
                <Text style={S.emptySubtitle}>
                  Send a message to your property owner to get started!
                </Text>
              </View>
            }
...
const S = StyleSheet.create({
  ...
  headerAvatar:    { width: 42, height: 42, borderRadius: 21, backgroundColor: "#EDE9FE", alignItems: "center", justifyContent: "center" },
  headerAvatarTxt: { fontSize: 17, fontWeight: "800", color: "#7C3AED" },
  ...
  dateLabel:       { fontSize: 11, color: "#9CA3AF", fontWeight: "600", paddingHorizontal: 6, backgroundColor: "#F3F0FF", borderRadius: 8 },
  ...
  avatar:       { width: 32, height: 32, borderRadius: 16, backgroundColor: "#EDE9FE", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  avatarTxt:    { fontSize: 13, fontWeight: "700", color: "#7C3AED" },
  bubbleCol:    { maxWidth: "75%" },
  senderName:   { fontSize: 10, fontWeight: "700", color: "#7C3AED", marginBottom: 2, marginLeft: 2 },

  bubble:       { paddingVertical: 8, paddingHorizontal: 13 },
  bubbleOwn:    { backgroundColor: "#7C3AED" },
