...
export default function AdminDashboard() {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const res = await fetch(`${API_ENDPOINTS.GET_ADMIN_STATS ?? API_ENDPOINTS.GET_PROPERTIES + "?admin_stats=1"}`);
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 20, paddingTop: 24, backgroundColor: "#fff", borderBottomWidth: 1, borderBottomColor: "#E2E8F0" },
